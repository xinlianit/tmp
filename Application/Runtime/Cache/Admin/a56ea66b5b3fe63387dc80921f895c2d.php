    ...
    <div class="main-container-inner">
                                ...
                                <div class="table-responsive">
                                    <div class="table-search">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right search-label" for="form-field-1">分类名称：</label>
                                            ...
                                            <span class="input-group-btn search-btn">
                                                <button type="button" class="btn btn-purple btn-sm" id="trade-search-button" surl='<?php echo U("Baseinfo/tradeCate");?>'>
                                                    查询
                                    ...
                                    <div class="table-search">
                                        <div class="form-group">
                                            <span class="input-group-btn search-btn">
                                                <button event-name="add-trade" type="button" class="btn btn-sm btn-success">
                                                    新增
                                                    <i class="icon-plus smaller-75"></i>
                                                </button>
                                                <div class="separate-2"><i class="separate-flag"></i></div>
                                                <button event-name="dels-trade" type="button" class="btn btn-sm btn-default">
                                                    删除
		...
		<td colspan="100" style="text-align:center;">暂无数据！</td>
                                        ...
                                        <?php if(is_array($page["list"])): $i = 0; $__LIST__ = $page["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                                <td class="center">
                                                    <label>
                                                        <input type="checkbox" name="type_item" value="<?php echo ($list["id"]); ?>" class="ace" />
                                                        <span class="lbl"></span>
                                                    </label>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">                                                      
                                                        ...
                                                        <a class="green" event-name="edit-trade" event-id="<?php echo ($list["id"]); ?>" info-url='<?php echo U("Baseinfo/getTradeInfo");?>' href="javascript:void(0);" title="编辑">
                                                            <i class="icon-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" event-name="del-trade"  event-id="<?php echo ($list["id"]); ?>" href="javascript:void(0);" title="删除">
...
<!-- 添加面板 -->
<div dialog-id="add-trade-box" class="hide">

    <form class="form-horizontal" role="form" form-id="add-trade-form" action="<?php echo U('Baseinfo/addtrade');?>" method="post">
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">分类名称：</label>

            <div class="col-sm-9">
                <input type="text" name="category_name" id="form-field-1" placeholder="输入分类名称" class="col-xs-10 col-sm-5">
            </div>
        </div>
        <div class="space-4"></div>
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">分类描述：</label>
...
<!-- 编辑面板 -->
<div dialog-id="edit-trade-box" id="edit-trade-box" class="hide">
    <form class="form-horizontal" role="form" form-id="edit-trade-form" action="<?php echo U('Baseinfo/editTrade');?>" method="post">
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商户类型名称：</label>

            <div class="col-sm-9">
                <input type="text" name="category_name" class="col-xs-10 col-sm-5">
...
<!-- 删除面板 -->
<div dialog-id="del-trade-box" class="hide">
    <h3>确定要删除吗？</h3>
    <form class="form-horizontal" role="form" form-id="del-trade-form" action="<?php echo U('Baseinfo/delTrade');?>" method="post">
...
<!-- 批量删除面板 -->
<div dialog-id="dels-trade-box" class="hide">
    <h3>确定要批量删除吗？</h3>
    <form class="form-horizontal" role="form" form-id="dels-trade-form" action="<?php echo U('Baseinfo/delTrade');?>" method="post">
