                                                            ...
                                                            <table class="table table-striped table-bordered table-hover">
                                                                <?php if(is_array($list["child"])): $i = 0; $__LIST__ = $list["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list2): $mod = ($i % 2 );++$i;?><tr>
                                                                    <td  class="align-right" style="width:5%">
                                                                        <input type="checkbox" class="ace" value="<?php echo ($list2["id"]); ?>" /><span class="lbl"></span>
                                                                    </td>
                                                                    <td style="width:5%"><?php echo ($list2["city_name"]); ?></td>
                                                                    <td  style="width:85%"><?php if(is_array($list2["child"])): $i = 0; $__LIST__ = $list2["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list3): $mod = ($i % 2 );++$i; echo ($list3["city_name"]); ?>；<?php endforeach; endif; else: echo "" ;endif; ?></td>
                                                                    <td class="hidden-480">
                                                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                                            <a class="green" event-name="edit" event-id="<?php echo ($list2["id"]); ?>" href="javascript:void(0);" title="编辑">
                                                                                <i class="icon-pencil bigger-130"></i>
                                                                            </a>

                                                                            <a class="red" event-name="del"  event-id="<?php echo ($list2["id"]); ?>" href="javascript:void(0);" title="删除">
...
<script src="/Public/plugins/assets/js/jquery-2.0.3.min.js"></script>
