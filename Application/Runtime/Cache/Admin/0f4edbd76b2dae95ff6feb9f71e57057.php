    ...
    <div class="main-container-inner">
                                    ...
                                    <div class="table-search">
                                        <div class="form-group">
                                            ...
                                            <span class="input-group-btn search-btn">
                                                <button type="button" class="btn btn-purple btn-sm" id="search-button" surl='<?php echo U("Adv/advMain");?>'>
                                                    查询
		...
		<td colspan="100" style="text-align:center;">暂无数据！</td>
                                        ...
                                        <?php if(is_array($page["list"])): $i = 0; $__LIST__ = $page["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td><?php echo ($list["industry_desc"]); ?></td>
                                                <td><?php echo ($list["contacts"]); ?></td>
                                                <td><?php echo ($list["contact_way"]); ?></td>
                                                <td><?php echo ($list["advert_num"]); ?></td>
                                                <td>展示商户数量</td>
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                        <a class="green" event-name="edit-advmain" event-id="<?php echo ($list["id"]); ?>" href="javascript:void(0);" title="编辑">
                                                            <i class="icon-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" event-name="del-advmain"  event-id="<?php echo ($list["id"]); ?>" href="javascript:void(0);" title="删除">
...
<!-- 添加面板 -->
<div dialog-id="add-advmain-box" class="hide">
    <form class="form-horizontal" role="form" form-id="add-advmain-form" action="<?php echo U('Adv/addAdver');?>" method="post">
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" >广告主名称：</label>
            <div class="col-sm-9">
                <input type="text" name="advert_name" placeholder="输入广告主名称" class="col-xs-10 col-sm-7">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="company_name" placeholder="输入公司名称" class="col-xs-10 col-sm-7">
            </div>
        </div>
        <div class="space-4"></div>
        
        <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right"> 行业描述：</label>
                <div class="col-sm-9">
                        <div class="category-box" tag-id="checked-type">
                                选择行业
                        </div>
                        <button event-name="add-type" url="<?php echo U('Baseinfo/tradeList');?>" type="button" class="btn btn-sm btn-success add-category">
                                添加行业分类
                        </button>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="contacts" placeholder="输入联系人" class="col-xs-10 col-sm-5">
            </div>
        </div>
        <div class="space-4"></div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="contact_way" placeholder="输入联系方式" class="col-xs-10 col-sm-7">
            </div>
        </div>
        <div class="space-4"></div>
...
<!-- 编辑面板 -->
<div dialog-id="edit-advmain-box" class="hide">
    <form class="form-horizontal" role="form" form-id="edit-advmain-form" action="<?php echo U('Adv/editAdver');?>" method="post">
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" >广告主名称：</label>
            <div class="col-sm-9">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right">公司名称：</label>
            <div class="col-sm-9">
                <input type="text" name="company_name"  class="col-xs-10 col-sm-7">
            </div>
        </div>
        <div class="space-4"></div>
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right">联系人：</label>
            <div class="col-sm-9">
                <input type="text" name="contacts"  class="col-xs-10 col-sm-5">
            </div>
        </div>
        <div class="space-4"></div>
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right">联系方式：</label>
            <div class="col-sm-9">
                <input type="text" name="contact_way" class="col-xs-10 col-sm-7">
            </div>
        </div>
        <div class="space-4"></div>
...
<!-- 删除面板 -->
<div dialog-id="del-advmain-box" class="hide">
    <h3>确定要删除吗？</h3>
    <p>删除后不可恢复！如果该广告主下面有发布的广告，请删除广告再删除广告主</p>
    <form class="form-horizontal" role="form" form-id="del-advmain-form" action="<?php echo U('Adv/delAdver');?>" method="post">
...
<!-- 删除面板多个 -->
<div dialog-id="dels-advmain-box" class="hide">
    <h3>确定要批量删除吗？</h3>
    <p>删除后不可恢复！如果该广告主下面有发布的广告，请删除广告再删除广告主</p>
    <form class="form-horizontal" role="form" form-id="dels-advmain-form" action="<?php echo U('Adv/delAdver');?>" method="post">
