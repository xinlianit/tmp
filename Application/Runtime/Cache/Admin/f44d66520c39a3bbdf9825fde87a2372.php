									...
									<div class="table-search">
										<form name="" action="" method="get">
											<div class="form-group">
												...
												<div class="seach-item">
													<label class="col-sm-3 control-label no-padding-right search-label sea-label" for="form-field-1">请求时间：</label>
													<input type="text" name="device_address" value="<?php echo ($_GET['device_address']); ?>" placeholder="YYYY-mm-dd" class="input-sm seach-input value" style="width:32%!important;">
													<span style="display:inline-block;margin:0px 5px;">至</span>
													<input type="text" name="device_address" value="<?php echo ($_GET['device_address']); ?>" placeholder="YYYY-mm-dd" class="input-sm seach-input value" style="width:32%!important;">
												</div>
												<div class="seach-item">
													<label class="col-sm-3 control-label no-padding-right search-label sea-label" for="form-field-1">服务状态：</label>
													<select name="room_type" class="form-control value">
														<option value="0">全部</option>
														<?php $_result=get_field_status('ROOM_INFO','ROOM_TYPE');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type_list): $mod = ($i % 2 );++$i;?><option <?php if($type_list['VALUE'] == $_GET['room_type']): ?>selected="selected"<?php endif; ?> value="<?php echo ($type_list["VALUE"]); ?>"><?php echo ($type_list["NAME"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
