									...
									<div class="table-search">
										<div class="form-group">
											<span class="input-group-btn search-btn">
												...
												<button event-name="delete" table-name="list" url="<?php echo U('Shopsetting/deleteService');?>" message="确认要删选中的 x 条服务指南？|删除后信息不可恢复！" type="button" class="btn btn-sm btn-default">
													删除
											...
											<?php if(is_array($page["list"])): $i = 0; $__LIST__ = $page["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
													...
													<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
															...
															<a class="green" event-name="addEditSerGuide" url="<?php echo U('Shopsetting/serviceInfo');?>" params="id=<?php echo ($list["id"]); ?>"  dialog-title="服务指南编辑" submit-title="保存" flag="edit" href="javascript:void(0);" title="编辑">
																<i class="icon-pencil bigger-130"></i>
															</a>
	
															<a class="red" event-name="delete" id-value="<?php echo ($list["id"]); ?>" url="<?php echo U('Shopsetting/deleteService');?>" message="确认要删除此服务指南？|删除后信息不可恢复！" href="javascript:void(0);" title="删除">
...
<div dialog-id="addEdit" class="hide">
	<form class="form-horizontal" role="form" form-id="addEdit" action="<?php echo U('Shopsetting/addEditService');?>" method="post">
