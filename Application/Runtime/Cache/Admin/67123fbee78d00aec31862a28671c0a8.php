    ...
    <div class="main-container-inner">
                                    ...
                                    <div class="table-search">
                                        <div class="form-group">
                                            ...
                                            <span class="input-group-btn search-btn">
                                                <button type="button" class="btn btn-purple btn-sm" id="icon-search-button" surl='<?php echo U("Baseinfo/iconList");?>'>
                                                    查询
		...
		<td colspan="100" style="text-align:center;">暂无数据！</td>
                                        ...
                                        <?php if(is_array($page["list"])): $i = 0; $__LIST__ = $page["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                                <td class="center">
                                                    <label>
                                                        <input type="checkbox" name="icon_item" value="<?php echo ($list["id"]); ?>" class="ace" />
                                                        <span class="lbl"></span>
                                                    </label>
                                                </td>
                                                
                                                <td><?php echo ($list["id"]); ?></td>
                                                <td><?php echo ($list["icon_name"]); ?></td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                        <a class="green" event-name="edit-icon" event-id="<?php echo ($list["id"]); ?>" href="javascript:void(0);" title="编辑">
                                                            <i class="icon-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" event-name="del-icon"  event-id="<?php echo ($list["id"]); ?>" href="javascript:void(0);" title="删除">
...
<div dialog-id="add-icon-box" class="hide">
    ...
    <form class="form-horizontal" role="form" form-id="add-icon-form" action="<?php echo U('Baseinfo/addicon');?>" method="post">
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">图标名称：</label>

            <div class="col-sm-9">
                <input type="text" name="icon_name" id="form-field-1" placeholder="输入图标名称" class="col-xs-10 col-sm-5">
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-3">图标描述：</label>
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-4">上传图标：</label>
...
<!-- 编辑面板 -->
<div dialog-id="edit-icon-box"  class="hide">
    <form class="form-horizontal" role="form" form-id="edit-icon-form" action="<?php echo U('Baseinfo/editIcon');?>" method="post">
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">图标名称：</label>

            <div class="col-sm-9">
                <input type="text" name="icon_name" id="form-field-1"  class="col-xs-10 col-sm-5">
            </div>
        </div>
        <div class="space-4"></div>
        
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-5"> 图标分类： </label>
            <div class="col-sm-9">
                <select class="col-xs-10 col-sm-5"  name="icon_category">
                    <option value="1">服务电话</option>
                    <option value="2">客房服务</option>
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">图标描述：</label>
...
<!-- 删除面板 -->
<div dialog-id="del-icon-box" class="hide">
    <h3>确定要删除吗？</h3>
    <form class="form-horizontal" role="form" form-id="del-icon-form" action="<?php echo U('Baseinfo/delIcon');?>" method="post">
...
<!-- 批量删除面板 -->
<div dialog-id="dels-icon-box" class="hide">
    <h3>确定要批量删除吗？</h3>
    <form class="form-horizontal" role="form" form-id="dels-icon-form" action="<?php echo U('Baseinfo/delIcon');?>" method="post">
