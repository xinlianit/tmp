		...
		<div tag-id="setup-2" class="hide">
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<select name="region_id" class="form-control area">
						<option value="">--区县--</option>
						<option value="1">福田区</option>
						<option value="2">南山区</option>
						<option value="3">龙华区</option>
					</select>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select name="trade_id" class="form-control area">
						...
						<option value="2">商圈1</option>
						<option value="3">商圈1</option>
					</select>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9 adv">
					...
					<div><input type="text" name="adver_number" placeholder="数量" class="col-xs-10" style="float:none;width:100%;"></div>
					<div>（最大数量为 6 ）</div>
				</div>
			</div>
