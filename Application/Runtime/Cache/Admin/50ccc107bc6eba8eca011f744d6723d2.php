    ...
    <div class="main-container-inner">
                                    ...
                                    <div class="table-search">
                                        <div class="form-group">
                                            ...
                                            <span class="input-group-btn search-btn">
                                                <button type="button" class="btn btn-purple btn-sm" id="shoptype-search-button" surl='<?php echo U("Baseinfo/shopType");?>'>
                                                    查询
                                    ...
                                    <div class="table-search">
                                        <div class="form-group">
                                            <span class="input-group-btn search-btn">
                                                ...
                                                <button event-name="dels-shop-type" type="button" class="btn btn-sm btn-default">
                                                    删除
		...
		<td colspan="100" style="text-align:center;">暂无数据！</td>
                                        ...
                                        <?php if(is_array($page["list"])): $i = 0; $__LIST__ = $page["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td><?php echo (_default($list["type_name"])); ?></td>
                                                <td>
                                                    <?php switch($list["type_class"]): case "1": ?>功能分类<?php break;?>
                                                        <?php case "2": ?>星级分类<?php break;?>
                                                        <?php case "3": ?>自定义<?php break; endswitch;?>
                                                </td>
                                                <td><?php echo (_default($list["type_desc"])); ?></td>
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">                                                      

                                                        <a class="green" event-name="edit-shop-type" event-id="<?php echo ($list["id"]); ?>" info-url="<?php echo U('Baseinfo/getTypeInfo');?>" href="javascript:void(0);" title="编辑">
                                                            <i class="icon-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" event-name="del-shop-type"  event-id="<?php echo ($list["id"]); ?>" href="javascript:void(0);" title="删除">
...
<div dialog-id="add-shop-type-box" class="hide">
    ...
    <form class="form-horizontal" role="form" form-id="add-shop-type-form" action="<?php echo U('Baseinfo/addType');?>" method="post">
        <div class="form-group">
...
<div dialog-id="edit-shop-type-box" id="edit-shop-type-box" class="hide">
    <form class="form-horizontal" role="form" form-id="edit-shop-type-form" action="<?php echo U('Baseinfo/editType');?>" method="post">
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商户类型名称：</label>
...
<!-- 删除面板 -->
<div dialog-id="del-shop-type-box" class="hide">
    <h3>确定要删除吗？</h3>
    <form class="form-horizontal" role="form" form-id="del-shop-type-form" action="<?php echo U('Baseinfo/delType');?>" method="post">
...
<!-- 批量删除面板 -->
<div dialog-id="dels-shop-type-box" class="hide">
    <h3>确定要批量删除吗？</h3>
    <form class="form-horizontal" role="form" form-id="dels-shop-type-form" action="<?php echo U('Baseinfo/delType');?>" method="post">
