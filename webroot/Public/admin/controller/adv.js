...
seajs.use(['webupload', 'module/adv'], function (webupload, adv) {
    $(function () {
        ...
        $(document).on('click', '[event-name="add-adv"]', function () {
            ...
            $.common.openWindow({
                ...
                next_function: function () {
                    ...
                    $('div[dialog-id=add-adv-box] div[material_type]').addClass('hide');
                    $('div[dialog-id=add-adv-box] div[material_type]:eq(0)').removeClass('hide');
        ...
        $(document).on('click', 'input[type=radio][name=material_type]',function(){
            ...
            $('.material_type').find('div[material_type]').addClass('hide');
            $('.material_type').find('div[material_type='+type_val+']').removeClass('hide');
            
            $.common.webupload_initialize(webupload,'advvideo_md5',2,'3gp,mp4');
        ...
        $(document).on('click', '[event-name="edit-adv"]', function () {
            ...
            $.common.openWindow({
                ...
                next_function: function () {
                    ...
                    $('div[dialog-id="edit-adv-box"] div[material_type]').addClass('hide');
                    $('div[dialog-id="edit-adv-box"] div[material_type]:eq('+(_material_type_val-1)+')').removeClass('hide');
                    ...
                    if(_res_info.material_type == 1){
                        $("#has_img_advpic").attr('src',_res_info.source_src);
                    }else{
                        $("#has_img_advvideo").attr('src',_res_info.source_src);
                        $("#has_img_advvideopic").attr('src',_res_info.thum_src);
                    }
